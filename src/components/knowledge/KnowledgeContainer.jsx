...
function KnowledgeContainer() {
  return (
    ...
    <div className="max-w-[1900px] mx-auto  py-20 mt-20	">
        ...
        <button className="rounded-full bg-transparent border-[#1C1C1C] border-2 px-8 py-4 text-[#1C1C1C]">Read more</button>
        </div>
